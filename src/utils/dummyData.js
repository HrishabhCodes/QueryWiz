// Dummy data taken from https://github.com/graphql-compose/graphql-compose-examples/tree/master/examples/northwind/data/json
...
export const getDummyData = () => {
  ...
  Object.keys(dummyData).forEach((table) => {
    const tableRows = dummyData[table];
    result[table] = {
      metaData: {
        table,
...
export const EXAMPLES = [
  ...
  {
    id: 2,
    example: "How many tables are there?",
  },
  {
    id: 3,
    example: "Which country has most number of shipments?",
  },
];

// Only a few data points from the whole data for testing
